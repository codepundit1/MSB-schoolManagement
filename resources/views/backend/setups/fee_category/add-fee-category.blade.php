                ...
                <div class="card">
                  <div class="card-header">
                    <h3>
                      ...
                      <a href="{{route('setups.fee.category.view')}}" class="btn btn-sm float-right btn-success"><i class="fa fa-arrow-left"></i><span class="ml-1">Back</span></a>
                    </h3>

                  </div>
                  <!-- /.card-header -->
                  <div class="card-body">
                        <form action="{{(isset($editData))?route('setups.fee.category.update', $editData->id):route('setups.fee.category.store')}}" method="post" id="myForm">
                            @csrf
                            <div class="form-row">
