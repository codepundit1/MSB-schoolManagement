                ...
                <div class="card">
                  <div class="card-header">
                    <h3>
                      ...
                      <a href="{{route('setups.student.shift.view')}}" class="btn btn-sm float-right btn-success"><i class="fa fa-arrow-left"></i><span class="ml-1">Back</span></a>
                    </h3>

                  </div>
                  <!-- /.card-header -->
                  <div class="card-body">
                        <form action="{{(isset($editData))?route('setups.student.shift.update', $editData->id):route('setups.student.shift.store')}}" method="post" id="myForm">
                            @csrf
                            <div class="form-row">
